...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Sobre Nosotros - Capital Code | Expertos en Desarrollo Digital</title>
        <meta name="description" content="Conozca al equipo detrás de Capital Code. Expertos apasionados por la tecnología y comprometidos con la excelencia en desarrollo de software." />
        <meta name="keywords" content="equipo desarrollo, expertos tecnología, consultores IT, Capital Code equipo, desarrollo software México" />
        <link rel="canonical" href="https://capitalcode.com/about" />
      </Helmet>
